...
export function About() {
  return <section id="about" className="section story-chapter philosophy machine-chapter" aria-labelledby="about-title">
    <div className="machine-panel">
    <div className="philosophy-copy"><p className="eyebrow">01 / BENEATH THE SURFACE</p><h2 id="about-title">Complexity.<br /><em>Under control.</em></h2><div className="prose"><p>{profile.summary}</p><p><span className="accent">Beyond the terminal</span> {profile.interests}</p></div></div>
