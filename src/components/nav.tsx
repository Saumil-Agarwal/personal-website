...
export function Nav() {
  return (
    <nav aria-label="Primary" className="nav shell">
      <a className="wordmark" href="#top">sa<span className="wordmark-dot">.</span></a>
      <details className="mobile-nav"><summary>Menu</summary><div><a href="#projects">Work</a><a href="#experience">Experience</a><a href="#contact">Contact</a></div></details>
